...
//            Toast.makeText(getApplicationContext(), "preparing", Toast.LENGTH_LONG).show();
        ...
        @Override
        protected String doInBackground(String... params) { // Don't print anything here !!!
//      for (int i=10;i<=100;i += 10)  //needed for showing the progress (every 10%)
//      {
//        try {
//          Thread.sleep(1000);
//          publishProgress(i);
...
//                URL url = new URL("http://localhost:8080/Route_Receiver/Receiver/index.php");
                ...
                if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                    ...
                    // otherwise, if any other status code is returned, or no status code is returned
                    result = "Response code " + connection.getResponseCode();
                }
            }catch (Exception e){
                result = "Error is " + e;
            }
...
//      Toast.makeText(getApplicationContext(), "Processing " + progress[0], Toast.LENGTH_LONG).show();
        }

        protected void onPostExecute(String result){
            //print return value
//            Toast.makeText(getApplicationContext(), "command sent! Result is " + result, Toast.LENGTH_LONG).show();
        }
    }
}
